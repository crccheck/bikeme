...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_station', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=6))

        # Changing field 'Station.latitude'
        db.alter_column(u'core_station', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Station.longitude'
        db.alter_column(u'core_station', 'longitude', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=5))

        # Changing field 'Station.latitude'
        db.alter_column(u'core_station', 'latitude', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=5))
