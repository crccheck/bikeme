...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Market.type'
        db.add_column(u'core_market', 'type',
                      self.gf('django.db.models.fields.CharField')(default='bcycle', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Market.type'
        db.delete_column(u'core_market', 'type')
