...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Market.active'
        db.add_column(u'core_market', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Station.active'
        db.add_column(u'core_station', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Market.active'
        db.delete_column(u'core_market', 'active')

        # Deleting field 'Station.active'
        db.delete_column(u'core_station', 'active')
